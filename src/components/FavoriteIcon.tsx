...
export default function FavoriteIcon({ className, style, isLiked = false }: FavoriteIconProps) {
	return (
		<div className={`flex items-center justify-center w-[0.8rem] h-[0.75rem] ${className || ''}`} style={style}>
			<svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[0.8rem] h-[0.75rem]">
				<path
					...
					fill={isLiked ? 'url(#paint0_linear_444_126)' : '#9CA3AF'}
				/>
				<defs>
					<linearGradient id="paint0_linear_444_126" x1="5.80001" y1="0.429016" x2="5.80001" y2="9.97102" gradientUnits="userSpaceOnUse">
