...
export default function FavoriteIcon({ className, style, isLiked = false }: FavoriteIconProps) {
	return (
		<div className={`flex items-center justify-center w-[0.65rem] h-[0.6rem] ${className || ''}`} style={style}>
			<svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[0.65rem] h-[0.6rem]">
				<path
