...
// 레이아웃 계산 함수
export const calculateSearchMargin = (layoutConfig: LayoutConfig, hasSearchTerm: boolean, isTouch: boolean): string => {
	...
	return SEARCH_MARGIN_CONFIG[searchBarTop as keyof typeof SEARCH_MARGIN_CONFIG] || SEARCH_MARGIN_CONFIG.default;
};

// 그리드 스타일 계산
export const calculateGridStyles = (layoutConfig: LayoutConfig, searchTerm: string, isTouch: boolean) => ({
